...
class CardOrderOwner extends StatelessWidget {
  ...
  CardOrderOwner({super.key, required this.orderProduct});
          ...
          Row(
            ...
            children: [
              ...
              ElevatedButton(
                style: ButtonStyle(
                  backgroundColor:
                      MaterialStateProperty.resolveWith((states) => color7),
                  shape: MaterialStateProperty.all(
                    RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(
                        12,
                ...
                onPressed: () {
                  Alert(
                    ...
                    desc: 'Apakah Anda Yakin Ingin Menghapus Order Product "' +
                        orderProduct.product!.name +
                        '" ' +
                        "Atas Nama " +
                        '"' +
                      ...
                      DialogButton(
                        ...
                        onPressed: () async {
                          await Provider.of<OrderProductProvider>(context,
                                  listen: false)
                              .deleteOrderProduct(
                                  id: int.parse(orderProduct.id.toString()));
